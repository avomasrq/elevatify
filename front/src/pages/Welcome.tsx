        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-8 md:mb-0">
              <div className="flex items-center">
                <div className="w-8 h-8 rounded-full bg-elevatify-600 flex items-center justify-center">
                  <span className="text-white font-bold text-sm">E</span>
                </div>
                <span className="ml-2 text-xl font-bold text-gray-900">Elevatify</span>
              </div>
              <p className="mt-4 text-gray-600 max-w-md">
                Empowering teenagers to connect, collaborate, and create meaningful projects together.
              </p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-600 hover:text-elevatify-600">Features</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-elevatify-600">Testimonials</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-elevatify-600">Pricing</a></li>
                </ul>
              </div>
              <div>
                <h4 className="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">Resources</h4>
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-600 hover:text-elevatify-600">Blog</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-elevatify-600">Guides</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-elevatify-600">Help Center</a></li>
                </ul>
              </div>
              <div>
                <h4 className="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">Company</h4>
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-600 hover:text-elevatify-600">About Us</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-elevatify-600">Careers</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-elevatify-600">Contact</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div className="border-t border-gray-200 mt-12 pt-8">
            <p className="text-gray-500 text-sm text-center">
              © {new Date().getFullYear()} Elevatify. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
